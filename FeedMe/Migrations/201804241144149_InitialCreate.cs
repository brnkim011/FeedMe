namespace FeedMe.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Reviews", "OutletID", "dbo.Outlets");
            DropForeignKey("dbo.Outlets", "Location_LocationID", "dbo.Locations");
            ...
            DropIndex("dbo.Reviews", new[] { "OutletID" });
            DropIndex("dbo.Outlets", new[] { "Location_LocationID" });
